...
<body>
	...
	<div class="container p-4 mb-5">
        ...
        <h3><?php echo $data['name'] ?></h3>
		  ...
		  <input class="form-control" type="text" name="cdate" id="cdate" Placeholder="Enter Date" required>
		  <script type="text/javascript">
			  $("#cdate").datepicker({
				  dateFormat: "dd-mm-yy",
        ...
        <center> <td><a href=""><button class="btn btn-primary mb-5 mt-4" name="submit" value="future">Submit</button></a><BR></center> 
